...
export default function PageClient({ metrics: metricsServer, docker: dockerServer, deleteAction }: PageClientProps) {
    ...
    const usedMemory = (metrics.system.memory.used / 1073741824).toFixed(2)
    const totalMemory = (metrics.system.memory.total / 1073741824).toFixed(2)
    const usedMemoryPercentage = metrics.system.memory.percent
                    ...
                    <div className='grid gap-2'>
                        <div className='flex gap-2'>
                            ...
                            <div className='bg-white/5 p-4 rounded-lg'>
                                ...
                                <div className='flex gap-2'>
                                    <h1>{metrics.system.processes}</h1>
                                </div>
                            </div>
                            <div className='bg-white/5 p-4 rounded-lg'>
                                <div className='flex gap-2 items-center'>
                            ...
                            <div className='bg-white/5 p-4 rounded-lg'>
                                ...
                                <div className='flex gap-2'>
                                    <h1>{metrics.system.temperature}</h1>
                                </div>
                            </div>
                            <div className='bg-white/5 p-4 rounded-lg'>
                                <div className='flex gap-2 items-center'>
                                ...
                                <div className='flex gap-2'>
                                    <h1>{metrics.system.powerUsage}</h1>
                                </div>
                            </div>
                        </div>
                        <div className='flex gap-2'>
                            ...
                            <div className='bg-white/5 p-4 rounded-lg grid gap-2'>
                                ...
                                <div className='flex gap-2'>
                                    <h1>1m {metrics.system.load[0]}%</h1>
                                    <h1 className='text-login-400'>|</h1>
                                    <h1>5m {metrics.system.load[1]}%</h1>
                                    <h1 className='text-login-400'>|</h1>
                                    <h1>15m {metrics.system.load[2]}%</h1>
                                </div>
                            </div>
                            <div className='bg-white/5 p-4 rounded-lg'>
                                <div className='flex gap-2 items-center'>
