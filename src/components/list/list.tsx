...
export default function List({list, sticky, visible}: ListProps) {
    ...
    return (
        <div className='relative overflow-visible overflow-y-auto max-h-[calc(100vh-var(--h-navbar)-var(--h-pageInfo))] noscroll w-fullo max-p-100 max-w-[calc(100vw-var(--w-sidebar))]'>
