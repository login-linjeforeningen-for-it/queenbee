        ...
        <div className='flex flex-col gap-12 relative'>
            ...
            <div className='flex flex-col gap-4'>
                <Input
                    ...
                    setValue={(input) => setFormValues({ ...formValues, shortname: input as string })}
                    required
                />
            ...
            <div className='flex flex-col gap-4'>
                ...
                <Input
                    ...
                    setValue={(input) => setFormValues({ ...formValues, link_homepage: input as string })}
                    required
                />
                <Input
                    name='link_linkedin'
                    ...
                    setValue={(input) => setFormValues({ ...formValues, link_linkedin: input as string })}
                />
                <Input
                    name='link_facebook'
                    type='text'
                ...
                <Input
                    ...
                    setValue={(input) => setFormValues({ ...formValues, link_instagram: input as string })}
                />
            </div>
            <div className='flex flex-col gap-4'>
                ...
                <Select
                    ...
                    setValue={(input) => setFormValues({ ...formValues, logo: input as string })}
                    required
                />
            </div>
        </div>
...
const sampleOrganization = {
    ...
    description_no: `🎓 Login er linjeforeningen for IT- og teknologistudenter ved NTNU Gjøvik.  
- Arrangerer sosiale og faglige aktiviteter  
- Nettverksbygging med næringslivet  
- Støtte til studenter gjennom semesteret`,
    description_en: `🎓 Login is the student organization for IT and technology students at NTNU Gjøvik.  
